    ...
    >
      ...
      <v-app-bar-title
        ...
        class="
          ...
          ml-n6 ml-sm-0
        "
        >global business</v-app-bar-title
      >
      <v-spacer></v-spacer>
      <v-btn text small @click="toggleTheme">
        <v-icon size="20" color="primary">{{ getThemeIcon }}</v-icon>
      </v-btn>
      <v-dialog>
        <template #activator="{ on, attrs }">
          <v-btn v-bind="attrs" text small v-on="on">
            <v-icon size="20" color="textColor">fas fa-search</v-icon>
          </v-btn>
        </template>
        ...
        <template #activator="{ attrs, on }">
          ...
          >
            <v-btn
              ...
              v-on="on"
            >
              <v-icon size="20" color="textColor">fas fa-bell</v-icon>
            </v-btn>
          </v-badge>
        </template>
      ...
      <v-menu offset-y>
        <template #activator="{ attrs, on }">
          ...
          >
            ...
            <v-icon size="10" color="textColor">fas fa-chevron-down</v-icon>
          </v-btn>
        </template>
