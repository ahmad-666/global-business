<template>
  <v-card color="adminCardColor" class="price-edit-form pb-4">
    <v-card-title class="d-flex justify-space-between align-center">
      <p class="text-caption white--text">Package</p>
      <v-btn text color="transparent" @click="closeCard">
        <v-icon size="16" color="red lighten-2">fas fa-times</v-icon>
      </v-btn>
    </v-card-title>
    <v-form
      ref="editForm"
    ...
    >
      <v-card-text class="py-0">
        ...
        <div>
          <p class="text-body-2 grey--text text--lighten-1">Description</p>
          <p class="mt-1 text-caption white--text">
