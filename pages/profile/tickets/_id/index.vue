<template>
  <div>
    ...
    <h6 class="text-h6 textColor--text font-weight-regular">Ticket Details</h6>
    <v-card color="cardColor" class="pa-0 mt-4">
      ...
      <v-card-text class="d-flex align-center flex-wrap">
        <p class="my-2 mx-4 text-body-2 titleColor--text">
          <v-icon color="titleColor" size="18" class="mr-2"
            >mdi-calendar-blank-outline</v-icon
          >
          {{ date }}
        </p>
        <p class="ma-2 text-body-2 titleColor--text">
          <v-icon color="titleColor" size="18" class="mr-2"
          ...
          <div class="border-dark pa-3">
            <div>
              ...
              <a
                ...
                "
              >
                <v-icon size="18" class="mr-2" color="info"
    ...
    return {
      breadcrumbItems: [
        ...
        },
        {
          text: 'Ticket Details',
          disabled: false,
          to: `/profile/tickets/${this.$route.params.id}`,
        },
      ],
      trackCode: '',
      title: '',
